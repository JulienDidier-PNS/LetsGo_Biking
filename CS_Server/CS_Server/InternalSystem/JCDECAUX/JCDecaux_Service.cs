...
namespace CS_Server.InternalSystem.JCDECAUX
{
    public class JCDecaux_Service
    {
        ...
        //liste des stations par contrats
        ...
        public JCContrat getContractByCityName(string cityName)
        {
        ...
        private void updateCache()
        {
            ...
            //if (DateTime.Now.Ticks - lastupdateStation.Ticks > DEFAULT_TTL_STATION) { updateStation(); }
        }
        ...
        internal JCStation getNearestStationFromPosition(GeoCoordinate coordinates,JCContrat contrat)
        {
        ...
        internal List<JCStation> getStationsFromContrat(JCContrat contrat)
        {
