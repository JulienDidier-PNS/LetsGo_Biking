...
@XmlType(name = "Engine", namespace = "http://schemas.datacontract.org/2004/07/CS_Server_Main.Exposed.Objects", propOrder = {
    "buildDate",
    "graphDate",
    "version"
})
public class Engine {
    ...
    @XmlElementRef(name = "version", namespace = "http://schemas.datacontract.org/2004/07/CS_Server_Main.Exposed.Objects", type = JAXBElement.class, required = false)
