 ...
 *         &lt;element name="steps" type="{http://schemas.datacontract.org/2004/07/CS_Server_Main.Exposed.Objects}ArrayOfStep" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "Segment", namespace = "http://schemas.datacontract.org/2004/07/CS_Server_Main.Exposed.Objects", propOrder = {
    "distance",
    "duration",
    "steps"
})
public class Segment {
    ...
    @XmlElementRef(name = "steps", namespace = "http://schemas.datacontract.org/2004/07/CS_Server_Main.Exposed.Objects", type = JAXBElement.class, required = false)
