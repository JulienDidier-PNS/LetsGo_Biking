...
@XmlType(name = "Step", namespace = "http://schemas.datacontract.org/2004/07/CS_Server_Main.Exposed.Objects", propOrder = {
    "distance",
    "duration",
    "instruction",
    "name",
...
public class Step {
    ...
    @XmlElementRef(name = "instruction", namespace = "http://schemas.datacontract.org/2004/07/CS_Server_Main.Exposed.Objects", type = JAXBElement.class, required = false)
