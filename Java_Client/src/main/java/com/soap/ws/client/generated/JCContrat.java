...
/**
 * <p>Classe Java pour JCContrat complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="JCContrat"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "JCContrat", namespace = "http://schemas.datacontract.org/2004/07/CS_ProxyCache_MAIN.Exposed.Objects", propOrder = {
    "cities",
    "commercialName",
    "countryCode",
    "name"
...
public class JCContrat {
    ...
    @XmlElementRef(name = "cities", namespace = "http://schemas.datacontract.org/2004/07/CS_ProxyCache_MAIN.Exposed.Objects", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfstring> cities;
    @XmlElementRef(name = "commercial_name", namespace = "http://schemas.datacontract.org/2004/07/CS_ProxyCache_MAIN.Exposed.Objects", type = JAXBElement.class, required = false)
    protected JAXBElement<String> commercialName;
    @XmlElementRef(name = "country_code", namespace = "http://schemas.datacontract.org/2004/07/CS_ProxyCache_MAIN.Exposed.Objects", type = JAXBElement.class, required = false)
