 ...
 *         &lt;element name="engine" type="{http://schemas.datacontract.org/2004/07/CS_Server_Main.Exposed.Objects}Engine" minOccurs="0"/&gt;
 *         &lt;element name="query" type="{http://schemas.datacontract.org/2004/07/CS_Server_Main.Exposed.Objects}Query" minOccurs="0"/&gt;
...
@XmlType(name = "Metadata", namespace = "http://schemas.datacontract.org/2004/07/CS_Server_Main.Exposed.Objects", propOrder = {
    "attribution",
    "engine",
    "query",
    "service",
...
public class Metadata {
    ...
    @XmlElementRef(name = "attribution", namespace = "http://schemas.datacontract.org/2004/07/CS_Server_Main.Exposed.Objects", type = JAXBElement.class, required = false)
    protected JAXBElement<String> attribution;
    @XmlElementRef(name = "engine", namespace = "http://schemas.datacontract.org/2004/07/CS_Server_Main.Exposed.Objects", type = JAXBElement.class, required = false)
    protected JAXBElement<Engine> engine;
    @XmlElementRef(name = "query", namespace = "http://schemas.datacontract.org/2004/07/CS_Server_Main.Exposed.Objects", type = JAXBElement.class, required = false)
    protected JAXBElement<Query> query;
    @XmlElementRef(name = "service", namespace = "http://schemas.datacontract.org/2004/07/CS_Server_Main.Exposed.Objects", type = JAXBElement.class, required = false)
